const questions = [
    ...
    },
    {
        ...
        'question': `A guarantee to an exporter that the importer of his goods will pay immediately for 
    ...
    {
        'question' : `When you enter a situation without a definite plan of 
        action, you are said to be 'playing it by' what?`,
        'content' : [
            'Fingertips',
            'Ear',
            'Nose',
    ...
    },
    {
        ...
        'question': `The escape velocity of a rocket fired from the earth towards 
        the moon is the velocity required to overcome`
    },
    {
        'correct': 3,
        'content': [
    ...
    },
    {
        ...
        'question': `For safety, the fuse wire used in the mains for 
